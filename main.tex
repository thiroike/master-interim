...
%   \begin{tabular}{lcc}
%     \toprule
%     \textbf{層 (Layer)} & \textbf{出力形状 ($H \times W \times C$)} & \textbf{備考 (Notes)} \\
%     \midrule
%     \multicolumn{3}{c}{\textit{--- Encoder ---}} \\
%     Input & $224 \times 224 \times 3$ & 入力画像 \\
%     inc (DoubleConv) & $224 \times 224 \times 64$ & \\
%     down1 (MaxPool + DoubleConv) & $112 \times 112 \times 128$ & \\
%     down2 (MaxPool + DoubleConv) & $56 \times 56 \times 256$ & \\
%     down3 (MaxPool + DoubleConv) & $28 \times 28 \times 512$ & \\
%     down4 (MaxPool + DoubleConv) & $14 \times 14 \times 512$ & ボトルネック, Dropout適用 \\
%     \midrule
%     \multicolumn{3}{c}{\textit{--- Decoder ---}} \\
%     up1 (Upsample + DoubleConv) & $28 \times 28 \times 256$ & Skip conn. from down3, Dropout適用 \\
%     up2 (Upsample + DoubleConv) & $56 \times 56 \times 128$ & Skip conn. from down2 \\
%     up3 (Upsample + DoubleConv) & $112 \times 112 \times 64$ & Skip conn. from down1 \\
%     up4 (Upsample + DoubleConv) & $224 \times 224 \times 64$ & Skip conn. from inc \\
%   \midrule
%   outc (Conv2d) & $224 \times 224 \times 2$ & 出力 ($2$クラス) \\
%   \bottomrule
%   \end{tabular}
% \end{table*}
